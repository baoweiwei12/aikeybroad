...
pidfile = '/www/wwwroot/aikeybroad/gunicorn.pid'

# 设置访问日志和错误信息日志路径
accesslog = '/www/wwwlogs/python/aikeybroad/gunicorn_acess.log'
errorlog = '/www/wwwlogs/python/aikeybroad/gunicorn_error.log'
